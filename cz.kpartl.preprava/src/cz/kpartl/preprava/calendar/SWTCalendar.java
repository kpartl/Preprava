package cz.kpartl.preprava.calendar;
...
public class SWTCalendar extends Composite {
	 ...
	 */
	public SWTCalendar(final Composite parent, int style) {
	...
	public void addListener(int type, Listener listener) {
		dayChooser.addListener(type, listener);
	}

	public void removeListener(int eventType, Listener listener) {
		dayChooser.removeListener(eventType, listener);
	}
